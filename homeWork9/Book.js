...
//Adding of Setters
set title (newTitle) {
  if (typeof newTitle !== "string") throw new Error("The title should be a string");
  this._title = newTitle;
};
set author (newAuthor) {
  if (typeof newAuthor !== "string") throw new Error("The author should be a string");
  this._author = newAuthor;
};
set year (newYear) {
  if (newYear <= 0) throw new Error("The year cannot be 0 or negative value"); 
  this._year = newYear;
};
}
